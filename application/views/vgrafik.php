...
<form method="get" action="">
        ...
        <a href="<?php echo base_url('grafikk'); ?>">Reset Filter</a>
    </form>
    <hr />
...
<script src="<?php echo base_url();?>assets/js/grafikk/jquery.js"></script>
<script src="<?php echo base_url();?>assets/js/grafikk/highcharts.js"></script>
<!-- end load library -->
 
<?php
    /* Mengambil query report*/
    foreach($transaksi as $result){
        $id_roti[] = $result->nama_roti; //ambil bulan
...
$(function () {
    $('#grafik').highcharts({
        ...
        xAxis: {
            categories:  <?php echo json_encode($id_roti);?>
        },
        exporting: { 
            enabled: false 
        },
